...
> All phases are complete. This document is kept as reference for why the codebase is structured the way it is.

The pipeline was built in **independent milestones** so each layer could be validated before the next was added.
